					...
					<table data-vertable="ver2">
						...
						<thead>
							<tr class="row100 head">
                                ...
                                <th class="column100 column4" data-column="column4">Tratamento</th>
						...
						<tbody>
							...
							<tr class="row100">
                                ...
                                <td class="column100 column4" data-column="column4">{{$lists->tratamento_produto}}</td>
                                ...
                                <td class="column100 column9" data-column="column9">
                                    <a href="/lente/editarmarca/{{$lists->id_produto}}">
                                        <button class="btn btn-outline-success">Editar</button>
                                    </a>
                                </td>

                                <td class="column100 column9" data-column="column9">
                                    <a href="/lente/excluirModelo/{{$lists->id_produto}}">
